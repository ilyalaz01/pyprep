...
| T4.3 | Layout shell: top-bar (no sidebar — MVP-1 keeps chrome thin), wordmark left, single-user badge center, user menu/logout right. Component library scaffold (Button/Input/Banner). | Lighthouse a11y ≥ 95; logout works | 🟡 |
