...
| T4.5 | `/modules/:id` (sphere list) + `/modules/:id/lesson/:sphereId` (lesson reader, react-markdown + shiki Python/JSON/bash/text only, restrained github-dark-dimmed). | Markdown renders with code highlighting; "Back to module" + "Start review session" actions wired | 🟡 |
