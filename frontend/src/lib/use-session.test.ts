...
// P6.5/P1-4 mid-session error recovery contract is pinned in a
// sibling file (use-session-error-recovery.test.ts) to keep this
// file under the 150-LOC ceiling. Sibling shares the json()/card()/
// sess()/mockFetch() helpers via duplication — small enough that a
// shared test-utils import isn't justified.
